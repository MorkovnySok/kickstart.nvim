    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gd', function()
            require('custom.adinsure').goto_definition {
              fallback = function()
          ...
          map('gs', require('telescope.builtin').lsp_type_definitions, '[G]oto [T]ype Definition')
          ...
          settings.apply_inlay_hints(settings.get('inlay_hints', false), event.buf)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_inlayHint, event.buf) then
            map('<leader>th', function()
              local state = not settings.get('inlay_hints', false)
              settings.set('inlay_hints', state)
              settings.apply_inlay_hints(state)
